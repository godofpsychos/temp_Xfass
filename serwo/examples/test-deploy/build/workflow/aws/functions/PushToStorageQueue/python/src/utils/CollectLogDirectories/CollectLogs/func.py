...
<<<<<<< HEAD:serwo/python/src/utils/CollectLogDirectories/CollectLogs/func.py
queue_name = 'xfaas-logging-queue-g9pq0lj'
=======
queue_name = 'xfaas-logging-queue-abc5gwa'
>>>>>>> QXFAAS:serwo/examples/test-deploy/build/workflow/aws/functions/PushToStorageQueue/python/src/utils/CollectLogDirectories/CollectLogs/func.py
