...
f=open("/home/tarun/XFaaS/serwo/examples/SerialSimulatorAWS/input-circuit.json")
body=json.load(f)
# body=json.loads(body)
z=user_function(SerWOObject(body=body))
body=z.get_body()
obj=json.dumps(body,default=str)
with open("/home/tarun/XFaaS/serwo/examples/SerialSimulatorAWS/splitter_out.json", "w") as f:
  json.dump(obj, f)
