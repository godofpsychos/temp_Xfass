...
def orchestrator_function(context: df.DurableOrchestrationContext):
    ...
    # user dag execution
    qajv = yield context.call_activity("Splitter", serwoObject)
    obzt = yield context.call_activity("Transpiler", qajv)
    kbpz = yield context.call_activity("Simulator", obzt)
    dbze = yield context.call_activity("Reconstructor", kbpz)
    dbze = insert_end_stats_in_metadata(dbze)
    nufq = yield context.call_activity("CollectLogs", dbze)
    return nufq
