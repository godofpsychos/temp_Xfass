...
def orchestrator_function(context: df.DurableOrchestrationContext):
    ...
    # user dag execution
    fphf = yield context.call_activity("Splitter", serwoObject)
    hqmq = yield context.call_activity("Transpiler", fphf)
    buqd = yield context.call_activity("Submitter", hqmq)
    rzvj = yield context.call_activity("Poller", buqd)
    xyew = yield context.call_activity("Reconstructor", rzvj)
    xyew = insert_end_stats_in_metadata(xyew)
    zvie = yield context.call_activity("CollectLogs", xyew)
    return zvie
