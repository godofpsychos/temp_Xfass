...
def orchestrator_function(context: df.DurableOrchestrationContext):
    ...
    # user dag execution
    nqar = yield context.call_activity("Invoke", serwoObject)
    ifzi = yield context.call_activity("Poll", nqar)
    ifzi = insert_end_stats_in_metadata(ifzi)
    adhy = yield context.call_activity("CollectLogs", ifzi)
    return adhy
